...
const Register = () => {
    ...
    return (
        ...
        <button aria-label="Login with Google" type="submit" className="flex items-center justify-center w-full my-5 p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-400 bg-sky-300 py-3">
